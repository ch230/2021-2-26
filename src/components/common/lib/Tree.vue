<template>
  <div class="tree" id="tree">
    <tree-node
      ...
      :data="item"
      @handleClick="
        $emit('handleClick', arguments[0], arguments[1], arguments[2])
      "
      @handleDblclick="
        $emit('handleDblclick', arguments[0], arguments[1], arguments[2])
      "
      @handleAdd="handleAdd"
      @handleRemove="
        $emit('handleRemove', arguments[0], arguments[1], arguments[2])
      "
  ...
  methods: {
    ...
    crossLine() {
      ...
      for (let i = 0; i < len; i++) {
        ...
        if (nodeLen > 1) {
          let $firstEl = el.children[0].children[0].children[0];
          let $lastEl =
            el.children[el.children.length - 1].children[0].children[0];
          ...
          $line.style.left =
            el.children[0].getBoundingClientRect().width / 2 + "px";
        }
      }
    },
    //关闭弹框的回调
