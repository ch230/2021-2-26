    ...
    <table v-if="treeData && treeData.partnerName">
        <tr>
            <td
                ...
                :class="{ parentLevel: treeData.childers, extend: treeData.childers && treeData.childers.length && treeData.extend }"
            >
                <div :class="{ node: true, hasMate: treeData.mate }">
                    <div class="person" @click="$emit('click-node', treeData)">
                        <el-popover v-if="!isDetail" placement="top" width="200" trigger="hover">
                            <div style="margin: 0">
                                <el-button
                                    size="mini"
                                    type="primary"
                                    @click="addStock(0)"
                                    v-if="treeData.partnerType !== 1 && treeData.partnerType !== 3"
                                    >添加</el-button
                                >
                                ...
                                <el-button type="primary" size="mini" @click="look" v-if="treeData.proportionShares">查看</el-button>
                            </div>
                            <div
                                class="avat"
                                :class="{
