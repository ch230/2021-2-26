    ...
    <div class="leader_wrap">
            ...
            <el-form :model="ruleForm" :inline="true" ref="ruleForm" class="demo-ruleForm">
                ...
                <el-form-item label="职级" prop="rank">
                    <el-select v-model="ruleForm.rank" placeholder="请选择">
                        <el-option key="bbk" label="A" value="bbk"></el-option>
                        <el-option key="xtc" label="B" value="xtc"></el-option>
                        <el-option key="imoo" label="C" value="imoo"></el-option>

                        <el-option key="bbk1" label="La" value="bbk1"></el-option>
                        <el-option key="xtc2" label="L1" value="xtc2"></el-option>
                        <el-option key="imoo3" label="L2" value="imoo3"></el-option>

                        <el-option key="bbk2" label="L3.1" value="bbk2"></el-option>
                        <el-option key="xtc1" label="L3.2" value="xtc1"></el-option>
                        <el-option key="imoo2" label="L4.1" value="imoo2"></el-option>

                        <el-option key="imoo1" label="L4.2" value="imoo1"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="最高学历" prop="credentials">
                    <el-select v-model="ruleForm.credentials" placeholder="请选择">
                        <el-option key="bbk" label="研究生" value="bbk"></el-option>
                        <el-option key="xtc" label="本科" value="xtc"></el-option>
                        <el-option key="imoo" label="专科" value="imoo"></el-option>
                        <el-option key="bbk1" label="中专/高中" value="bbk1"></el-option>
                        <el-option key="xtc2" label="初中" value="xtc2"></el-option>
                        <el-option key="imoo3" label="小学" value="imoo3"></el-option>
                    </el-select>
                </el-form-item>

                <el-form-item label="年龄" prop="age">
                    <el-select v-model="ruleForm.age" placeholder="请选择">
                        <el-option key="bbk" label="25岁一下" value="bbk"></el-option>
                        <el-option key="xtc" label="25~30" value="xtc"></el-option>
                        <el-option key="imoo" label="30~35" value="imoo"></el-option>

                        <el-option key="bbk1" label="35~40" value="bbk1"></el-option>
                        <el-option key="xtc2" label="40~45" value="xtc2"></el-option>
                        <el-option key="imoo3" label="45~50" value="imoo3"></el-option>

                        <el-option key="bbk2" label="50~55" value="bbk2"></el-option>
                        <el-option key="xtc1" label="55岁以上" value="xtc1"></el-option>
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="政治面貌" prop="politicsStatus">
                    <el-select v-model="ruleForm.politicsStatus" placeholder="请选择">
                        <el-option key="bbk" label="党员" value="bbk"></el-option>
                        <el-option key="xtc" label="团员" value="xtc"></el-option>
                        <el-option key="imoo" label="预备党员" value="imoo"></el-option>

                        <el-option key="bbk1" label="群众" value="bbk1"></el-option>
                        <el-option key="xtc2" label="其他" value="xtc2"></el-option>
                    </el-select>
                </el-form-item>

                <el-form-item label="任期" prop="tenure">
                    <el-select v-model="ruleForm.tenure" placeholder="请选择">
                        <el-option key="yes" label="任期未满" value="yes"></el-option>
                        <el-option key="no" label="任期满" value="no"></el-option>
                    </el-select>
                </el-form-item>

                <el-form-item label="干部属性" prop="cadreProperties">
                    <el-select v-model="ruleForm.cadreProperties" placeholder="请选择">
                        <el-option key="1" label="党委干部" value="1"></el-option>
                        <el-option key="2" label="行政干部" value="2"></el-option>
                        <el-option key="3" label="团委干部" value="3"></el-option>
                        <el-option key="4" label="项目群干部" value="4"></el-option>
                    </el-select>
                </el-form-item>
        ...
        <div class="leader_table">
            <el-table :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="credentials" label="最高学历"></el-table-column>
                <el-table-column prop="politicsStatus" label="政治面貌"></el-table-column>
                <el-table-column prop="tenure" label="任期"> </el-table-column>
                <el-table-column prop="cadreProperties" label="干部属性"></el-table-column>
